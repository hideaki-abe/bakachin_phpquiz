    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const quizData = [{
                ...
                {
                    question: "PHPの最新バージョンは　　　どれですか？（2024年6月現在）",
                    a: "7.4",
                    b: "9.2",
                    c: "8.3",
                    correct: "c"
                ...
                {
                    question: "PHPで変数を宣言するための　　正しい方法はどれですか？",
                    a: "$変数名",
                    b: "var 変数名",
                    c: "let 変数名",
                    correct: "a"
                ...
                if (answer) {
                    ...
                    if (currentQuiz < quizData.length) {
                        ...
                        fetch('save_score.php', {
                            ...
                            document.querySelector('.quiz-container').innerHTML = `<h2>【結果発表】成績は${score}／${quizData.length}です！</h2><button onclick="location.reload()">リトライ</button><a href="ranking.php" class="ranking-link">ランキングを見る</a>`;
                        });
                    }
                }
            });
